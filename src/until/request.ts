 ...
 * @returns Promise<T>
 */
const CANCEL_TOKEN = axios.CancelToken // 终止axios请求（配合摄像设备）
function apiAxios(method: any, url: string, params: any,  cancel?: any) {
	if (params) {
...
export default {
	...
	post: (url: any, params?: any, cancel?: any) => {
		return apiAxios('POST', url, params, cancel)
	},
